  ...
  return (
    <div className=" mt-2 mb-2 ">
      <div className="flex my-4 justify-between items-center px-3 py-2 bg-slate-100 mx-1 rounded-md">
        ...
        <button
          type="button"
          className="px-3 py-2 text-xs font-medium text-center text-white bg-cyan-500 rounded-lg hover:bg-cyan-700 focus:ring-4 focus:outline-none focus:ring-blue-300"
        >
         View More
        </button>
      </div>
